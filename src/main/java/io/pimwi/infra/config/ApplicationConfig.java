...
import io.pimwi.infra.util.Features;
...
import static io.pimwi.infra.util.PropertyHelper.setProperty;

@Configuration
@ComponentScan(basePackages = {"io.pimwi"})
@PropertySource("classpath:application.properties")
@EnableScheduling
@EnableTransactionManagement
@EnableJpaRepositories("io.pimwi.infra.repository")
...
*/
    ...
    MultipartResolver multipartResolver() {
        ...
        resolver.setMaxUploadSize(65536);
        return resolver;
    }
